...
import { MessageSquare, Loader2, AlertCircle, Home } from 'lucide-react'
      ...
      <div style={{ position: 'relative', zIndex: 10, minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '32px' }}>
            ...
            <h1 style={{ fontSize: '24px', fontWeight: 600, margin: 0 }}>Client Login</h1>
          </div>
          ...
          <div style={{ marginTop: '24px', textAlign: 'center', fontSize: '14px', color: '#a3a3a3' }}>
            <p style={{ margin: 0, marginBottom: '8px' }}>
              <Link href="/forgot-password" style={{ color: '#3b82f6', textDecoration: 'none' }}>
                Forgot Password?
              </Link>
            </p>
            <p style={{ margin: 0, marginBottom: '8px' }}>
              Don't have an account?{' '}
              <Link href="/onboard" style={{ color: '#3b82f6', textDecoration: 'none' }}>
                Sign up
              </Link>
            </p>
            <p style={{ margin: 0, marginBottom: '8px' }}>
              <Link href="/admin/login" style={{ color: '#3b82f6', textDecoration: 'none' }}>
                Admin login
              </Link>
            </p>
            <p style={{ margin: 0 }}>
